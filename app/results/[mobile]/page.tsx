...
export default async function QuickResultViewPage({
  ...
  return (
    <div className="min-h-screen relative z-10">
      {/* Top bar */}
      <div className="bg-white/5 backdrop-blur-md border-b border-white/20 px-4 py-3 flex items-center justify-between">
        <Link
          href="/results"
          className="flex items-center gap-1.5 text-sm text-white/60 hover:text-[#0D9488] transition-colors"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display italic text-lg text-white/95">Janseva</span>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-xl font-bold text-white/95">Your Reports</h1>
